function bw_cost = data_delivery_opt_bwcost(ov_sets,len_of_sets,N,M,beta,bw_edge,mem_edge,mem_occup,mem_app,x,v2e_trvtime,vel_free,bandwidth,density_jam,density,bw_const,l_cov)
